...
export default function SectionReformas() {
    return(
        <div className="flex w-full flex-col pb-6">
            <div className="w-[420px] ml-12 mt-4">
            <h1 className="text-4xl text-gray-500 font-bold list-item">Reformas de ambiente</h1>
            <hr className="border-solid border-y-orange-300 border-y-4 rounded-full" />
            </div>
            <div className="flex w-full justify-evenly mt-4">
                <div className="flex flex-col w-[270px]">
                <Image src={Amostra1} className="w-[270px] h-[220px]" alt="amostra de reforma"/>
...
Confira...</p>
                ...
                <div className="flex flex-col w-[270px]">
                <Image src={Amostra2} className="w-[270px] h-[220px]" alt="amostra de reforma"/>
...
sua cozinha. Confira!...</p>
                ...
                <div className="flex flex-col w-[270px]">
                <Image src={Amostra3} className="w-[270px] h-[220px]" alt="amostra de reforma"/>
...
Confira...</p>
            ...
            <div className="w-[440px] ml-12 mt-4">
            <h1 className="text-4xl text-gray-500 font-bold list-item">Reforma de acabamento</h1>
            <hr className="border-solid border-y-orange-300 border-y-4 rounded-full" />
            </div>
            <div className="flex w-full justify-evenly mt-4">
                <div className="flex flex-col w-[270px]">
                <Image src={Amostra4} className="w-[270px] h-[220px]" alt="amostra de reforma"/>
...
novas. Confira!...</p>
                ...
                <div className="flex flex-col w-[270px]">
                <Image src={Amostra5} className="w-[270px] h-[220px]" alt="amostra de reforma"/>
...
Confira!</p>
                ...
                <div className="flex flex-col w-[270px]">
                <Image src={Amostra6} className="w-[270px] h-[220px]" alt="amostra de reforma"/>
